        ...
        <v-container fluid>
          ...
          <v-row class="text-center fill-height" align="center">
            ...
            <v-col cols="12" sm="8" md="4">
              ...
              <br/>
              <v-card elevation="20"  style="padding:10px;" align="center"> 
                <v-card-text>
                  <v-img src="/assets/logo.png" width="100" height="100"></v-img>
                </v-card-text>
                 <h1  class="blue--text tetx-bold">Documentation</h1>
                ...
                >
                  ...
                  <v-text-field
                    ...
                    required
                  ></v-text-field>
                   <v-alert dense text type="error" style="color:green;" v-show="wrongpass">{{message}}</v-alert>
...
this.isLoading = true;
 this.wrongpass = false;
       ...
       this.$axios
          ...
          .then((response) => {
            if(response.data.success){
              ...
              window.location.href = '/create-documentation'
            }
  ...
  <style scoped>
  .main {
  background-image: url("/assets/documentation.jpeg");
